...
#[derive(Debug)]
pub struct OtakuFactoryProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OtakuFactoryProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OtakuFactory processing");
    
    let mut processor = OtakuFactoryProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OtakuFactoryProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OtakuFactoryProcessor::new(false);
